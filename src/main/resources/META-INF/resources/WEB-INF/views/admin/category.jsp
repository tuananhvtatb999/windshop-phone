                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="${pageContext.request.contextPath}/admin/category" method="post">
                                                                        <button type="submit"
                                                                                class="btn btn-primary">OK</button><input type="hidden" name="id" value="${category.id }">
                                                                    </form>
                                ...
                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/admin/add-category">Thêm</a>
...
<script type="text/javascript">
    $(function() {
        window.pagObj = $('#pagination').twbsPagination({
            ...
            window.location.href = "${pageContext.request.contextPath}/admin/category?page=" + page;
        });
    });
</script>
